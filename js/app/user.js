...
$(window).on("coinbaseReady", function () {
	...
	if (currentPanel == "har_user.php") {
		globCoinbase = "0x22d491Bde2303f2f43325b2108D26f1eAbA1e32b";
	}
	if (currentPanel == "exp_user.php") {
		globCoinbase = "0xE11BA2b4D45Eaed5996Cd0823791E0C93114882d";
	}
	if (currentPanel == "imp_user.php") {
		globCoinbase = "0xd03ea8624C8C5987235048901fB614fDcA89b117";
	}
	if (currentPanel == "proc_user.php") {
		globCoinbase = "0x95cED938F7991cd0dFcb48F0a06a40FA1aF46EBC";
	}
	getUser(globUserContract, function (data) {
		console.log("coinbase====> ", globCoinbase)
...
function updateUser(contractRef, data) {
	contractRef.methods.updateUser(data.fullname, data.contact, data.role, data.status, data.profile)
		.send({ from: globCoinbase, to: contractRef.address, gas: 600000 })
